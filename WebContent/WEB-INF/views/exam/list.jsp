...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td align="right">论述题数量:</td>
                <td><input type="text" placeholder="每个判断题${lunshuScore}分" id="add-lunshuQuestionNum" name="lunshuQuestionNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试论述题数量'" ></td>
            </tr>
        </table>
    </form>
</div>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           <tr>
            ...
            <tr>
                <td align="right">论述题数量:</td>
                <td><input type="text" placeholder="每个判断题${lunshuScore}分" id="edit-lunshuQuestionNum" name="lunshuQuestionNum" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请填写考试论述题数量'" ></td>
            </tr>
        </table>
    </form>
</div>
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'lunshuQuestionNum',title:'论述题数量',width:150},
