	...
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                ...
                <td>
                	<select id="addType" name="questionType" class="easyui-combobox easyui-validatebox"
                            panelHeight="auto" style="width:268px" data-options="required:true, missingMessage:'请选择试题类型'">
		                <option value="0">单选</option>
		            	<option value="1">多选</option>
		            	<option value="2">判断</option>
                        <option value="3">论述</option>
	...
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
            	...
            	$("#edit-questionType")
                    .combobox({onChange: (newv) => {
                        $(".xuanx").each(item => {
                            $($(".xuanx")[item]).css("display", newv == 3 ? 'none': 'table-row');
                        })
                    },
                        onLoadSuccess: () =>{
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
			...
			{ field:'answer',title:'正确答案',width:180},
