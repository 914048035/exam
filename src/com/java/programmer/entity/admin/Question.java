...
public class Question {
	...
	public static int QUESTION_TYPE_LUNSHU = 3;//论述题型
	//试题分值定义，根据试题类型定义分值
	...
	public static int QUESTION_TYPE_LUNSHU_SCORE = 10;//论述题型,每题⑩分
	...
	public void setScoreByType(){
		...
		if(questionType == QUESTION_TYPE_LUNSHU)score = QUESTION_TYPE_LUNSHU_SCORE;
	}
}
