...
public class Exam {
	...
	private int lunshuQuestionNum;//论述题数量
	...
	public int getLunshuQuestionNum() {
		return lunshuQuestionNum;
	}

	public void setLunshuQuestionNum(int lunshuQuestionNum) {
		this.lunshuQuestionNum = lunshuQuestionNum;
	}
